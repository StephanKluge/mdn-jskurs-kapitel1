...
// Char-Erstellung als Funktion. Allerdings kann man dann später nicht mehr auf den Charnamen zugreifen.
// function adventureBeginn(){
//     const charCreate = prompt("Bitte geben Sie den Namen Ihres Charakter ein:", "");
//     const playerName = charCreate;
//     alert("Der Spielername lautet: "+playerName);
// }

// adventureBeginn();


// Char-Erstellung als Funktion mit globalen Zugriff auf Char-Namen.
// const charCreate = prompt("Bitte geben Sie den Namen Ihres Charakter ein:", "");
// const playerName = charCreate;
// function adventureBeginn(from, text){
//     alert(from + ": " + text);
// }

// adventureBeginn(playerName, "it's the beginn of an super fancy Adventure. Have Fun Buddy!");
// adventureBeginn(playerName, "Now go and burn some Ork's back to the Hell!Gan");
 
// Charerstellung mit return.
